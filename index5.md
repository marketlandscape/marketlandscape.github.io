...
<div class="indexes">
  ...
  <div style="margin-bottom:28px;">
    <div id="box1" class="index-box" style="background-image:url('/assets/img/mobile-bar-scale-grey.svg');">
      ...
      <div style="position:absolute;left:24px;top:88px;width:306px;display:flex;font-size:13px;color:#d9d9d9;opacity:0.5;letter-spacing:0.02em;z-index:2;pointer-events:none;">
      ...
      <svg class="dot-layer" viewBox="0 0 360 150" xmlns="http://www.w3.org/2000/svg">
        <circle id="dotOuter1" cx="30" cy="118" r="9" fill="#323232ff"/>
        <circle id="dotInner1" cx="30" cy="118" r="6" fill="#ffffff"/>
      </svg>
    </div>
  </div>
  ...
  <div style="margin-bottom:28px;">
    <div id="box2" class="index-box" style="background-image:url('/assets/img/mobile-bar-scale-grey.svg');">
      ...
      <div style="position:absolute;left:33.75px;top:88px;width:306px;display:flex;font-size:13px;color:#d9d9d9;opacity:0.5;letter-spacing:0.02em;z-index:2;pointer-events:none;">
        <span style="flex:1;text-align:center;">Entry</span>
        <span style="flex:1;text-align:center;">Scale In</span>
