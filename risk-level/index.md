...
Different coin classes carry different baseline risks by design. This reflects a persistent and observable feature of crypto markets: assets with lower liquidity and smaller market capitalization fall more, and faster, when Bitcoin weakens. As a result, risk is inherently uneven across asset classes even when the same Bitcoin move is used as the reference shock.
