...
function setValue(boxKey, boxId, x){
  ...
  // 180×180 geometry (scaled from the 200×200 version)
  // left limit = 23px, right limit = 157px  (range 134px)
  const LEFT = 23;
  const RANGE = 134;
