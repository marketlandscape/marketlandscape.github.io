...
<div class="indexes-grid">
  ...
  <div class="row">
    ...
    <div class="index-box side"
         style="background-image:url('/assets/img/mobile-grey-240.svg');">
      <div class="box-title">Auxiliary Index A</div>
    </div>
  </div>
  ...
  <div class="row">
    ...
    <div class="index-box side"
         style="background-image:url('/assets/img/mobile-grey-240.svg');">
      <div class="box-title">Auxiliary Index B</div>
    </div>
  </div>
  ...
  <div class="row">
    ...
    <div class="index-box side"
         style="background-image:url('/assets/img/mobile-grey-240.svg');">
      <div class="box-title">Auxiliary Index C</div>
    </div>
  </div>
